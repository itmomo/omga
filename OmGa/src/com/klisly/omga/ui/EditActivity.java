...
//	Button commitButton;
	...
	protected void findViews() {
		...
		openLayout = (LinearLayout)findViewById(com.klisly.omga.R.id.open_layout);
		takeLayout = (LinearLayout)findViewById(com.klisly.omga.R.id.take_layout);
	...
	protected void setupViews(Bundle bundle) {
		...
		actionbar.setHomeAction(new Action() {
			...
			public int getDrawable() {
				// TODO Auto-generated method stub
				return com.klisly.omga.R.drawable.logo;
			}
		});
...
//			}
//			break;
		case com.klisly.omga.R.id.open_layout:
	...
	private void publish(final String commitContent){
		...
		final BmobFile figureFile = new BmobFile(Qiushi.class, new File(targeturl));
	...
	private void publishWithoutFigure(final String commitContent,
		...
		final Qiushi qiangYu = new Qiushi();
