...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        CharSequence title = a.getString(com.klisly.omga.R.styleable.ActionBar_title);
        if (title != null) {
            setTitle(title);
        }
        a.recycle();
...
//        mBackIndicator.setBackgroundResource(R.drawable.actionbar_back_indicator);
        mBackIndicator.setImageResource(show?com.klisly.omga.R.drawable.back_indicator:android.R.color.transparent);
    }
    ...
    private View inflateAction(Action action) {
        View view = mInflater.inflate(com.klisly.omga.R.layout.actionbar_item, mActionsView, false);
